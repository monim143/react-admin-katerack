                                ...
                                <div className="card m-b-20">
                                    <div className="card-body">
                                        ...
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-10">
                                                <input className="form-control" type="text" placeholder="hunter2"
                                        ...
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-10">
                                                <input className="form-control" type="number" placeholder="42"
                                        ...
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-10">
                                                <input className="form-control" type="month" value="2011-08"
                                        ...
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-10">
                                                <input className="form-control" type="week" value="2011-W33"
                                        ...
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-10">
                                                <input className="form-control" type="color" value="#67a8e4"
                                        ...
                                        <div className="form-group row">
                                            <label for="example-text-input-lg"
                                                   className="col-sm-2 col-form-label">Large</label>
                                            <div className="col-sm-10">
                                        ...
                                        <div className="form-group row">
                                            <label for="example-text-input-sm"
                                                   className="col-sm-2 col-form-label">Small</label>
                                            <div className="col-sm-10">
                                        ...
                                        <div className="form-group row has-success">
                                            <label for="inputHorizontalSuccess"
                                                   className="col-sm-2 col-form-label">Email</label>
                                            <div className="col-sm-10">
                                                <input type="email" className="form-control form-control-success"
                                                       id="inputHorizontalSuccess" placeholder="name@example.com"/>
                                                <div className="form-control-feedback">Success! You've done it.</div>
                                                <small className="form-text text-muted">Example help text that remains
                                                    unchanged.</small>
                                            </div>
                                        </div>
                                        <div className="form-group row has-warning">
                                            <label for="inputHorizontalWarning"
                                                   className="col-sm-2 col-form-label">Email</label>
                                            <div className="col-sm-10">
                                                <input type="email" className="form-control form-control-warning"
                                                       id="inputHorizontalWarning" placeholder="name@example.com"/>
                                                <div className="form-control-feedback">Shucks, check the formatting of
                                                    that and try again.
                                                </div>
                                                <small className="form-text text-muted">Example help text that remains
                                                    unchanged.</small>
                                        ...
                                        <div className="form-group row has-danger">
                                            <label for="inputHorizontalDnger"
                                                   className="col-sm-2 col-form-label">Email</label>
                                            <div className="col-sm-10">
                                                <input type="email" className="form-control form-control-danger"
                                                       id="inputHorizontalDnger" placeholder="name@example.com"/>
                                                <div className="form-control-feedback">Sorry, that username's taken. Try
                                                    another?
                                                </div>
                                                <small className="form-text text-muted">Example help text that remains
                                                    unchanged.</small>
