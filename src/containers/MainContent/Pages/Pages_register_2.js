...
render(){
    let hrefHash = 'javascript:void(0);';
    return(
           <AUX>
        ...
        <div className="wrapper-page account-page-full">
            ...
            <div className="card">
                <div className="card-body">
                    ...
                    <div className="p-3">
                        ...
                        <p className="text-muted text-center">Get your free Katerack account now.</p>
                        ...
                        <form className="form-horizontal m-t-30" action="/">
                            ...
                            <div className="form-group m-t-10 mb-0 row">
                                <div className="col-12 m-t-20">
                                    <p className="font-14 text-muted mb-0">By registering you agree to the Katerack <a href={hrefHash}>Terms of Use</a></p>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div className="m-t-40 text-center">
                ...
                <p className="">©  {new Date().getFullYear()} Katerack. Crafted with <i className="mdi mdi-heart text-danger"></i> by MA Monim</p>
            </div>
        </div>
           </AUX>
        );
