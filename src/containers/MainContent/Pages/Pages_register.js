    ...
    return(
           <AUX>
                        ...
                        <form className="form-horizontal m-t-30" action="index.html">
                            ...
                            <div className="form-group m-t-10 mb-0 row">
                                <div className="col-12 m-t-20">
                                    <p className="font-14 text-muted mb-0">By registering you agree to the Katerack <Link to="#">Terms of Use</Link></p>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div className="m-t-40 text-center">
                ...
                <p className="text-white">©   {new Date().getFullYear()} Katerack. Crafted with <i className="mdi mdi-heart text-danger"></i> by MA Monim</p>
            </div>
